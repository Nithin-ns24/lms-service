...
public final class JsonKey {
  ...
  public static final List<String> CHANGE_IN_SIMPLE_DATE_FORMAT = Arrays.asList(START_DATE, END_DATE, ENROLLMENT_END_DATE);
  public static final List<String> CHANGE_IN_DATE_FORMAT = Arrays.asList(CREATED_DATE, UPDATED_DATE);
  public static final List<String> CHANGE_IN_DATE_FORMAT_ALL = Arrays.asList(START_DATE, END_DATE, ENROLLMENT_END_DATE, CREATED_DATE, UPDATED_DATE);
  ...
  public static final List<String> SET_END_OF_DAY = Arrays.asList(END_DATE, ENROLLMENT_END_DATE);
